    ...
    return (
      <div className="space-y-2 rounded-lg border border-border p-3">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            id="tg-token"
            name="gatewayops-telegram-token"
            type="password"
        ...
        <div className="space-y-1.5">
          ...
          <Input
            id="tg-chat"
            name="gatewayops-telegram-chat-id"
            autoComplete="off"
      ...
      <div className="space-y-2 rounded-lg border border-border p-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1.5">
            ...
            <Input
              id="em-user"
              name="gatewayops-notify-email-username"
              autoComplete="off"
              data-lpignore="true"
              value={cfg.username}
          ...
          <div className="space-y-1.5">
            ...
            <Input
              id="em-pass"
              name="gatewayops-notify-email-secret"
              type="password"
              autoComplete="new-password"
              data-lpignore="true"
              value={cfg.password}
    ...
    <div className="space-y-2 rounded-lg border border-border p-3">
      ...
      {supportsSecret ? (
        <div className="space-y-1.5">
          ...
          <Input
            id="wb-secret"
            name="gatewayops-notify-webhook-secret"
            type="password"
            autoComplete="new-password"
            data-lpignore="true"
            value={cfg.secret}
      ...
      {row.mode === "groups" ? (
        <div className="space-y-1.5">
          {row.channel_id == null ? (
            ...
            <ScrollArea type="auto" className="h-32 w-full rounded border border-border bg-muted/30 p-2">
